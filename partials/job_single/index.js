								...
								<div className="row bg-border">
									...
									<div className="col-xl-6">
										<div className="btn-right">
											<Link route="page" slug="career/available-jobs">
												<a className="btn btn-custom">Back to available jobs</a>
											</Link>
										</div>
									</div>
								</div>

								<div className="job-item border-all">
									<div className="job-header media bg-border" style={{ marginBottom: 30 }}>
										<img src={item.thumb} width={115} />
										<div className="media-body media-sp">
											<h4>{this.daysDiff(item.publish_at)} days left</h4>
